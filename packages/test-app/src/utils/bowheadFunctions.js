...
const config = {
    firebase: {
        ...
        databaseUrlProduction: process.env.REACT_APP_FIREBASE_FIRESTORE_PROD_DATABASE_URL,
        databaseUrlDevelopment: process.env.REACT_APP_FIREBASE_FIRESTORE_DEV_DATABASE_URL,
    },
    stripe: {
